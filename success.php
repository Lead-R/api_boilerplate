...
<head>
    ...
    <title><?php echo $messages[$mess_geo]['message_title_success'] ?></title>
</head>
<body>
<div class="wrap_block_success">
    <div class="block_success">
        <h2><?php echo $messages[$mess_geo]['message_order_id'] ?></h2>
        <p class="success"><?php echo $messages[$mess_geo]['message_contact'] ?></p>
        <h3><?php echo $messages[$mess_geo]['message_check_data'] ?></h3>
        <div class="wrap_list_info">
            <ul class="list_info">
                <li><span><?php echo $messages[$mess_geo]['message_fio'] ?>:</span> <?php echo $name; ?></li>
                <li><span><?php echo $messages[$mess_geo]['message_phone'] ?>:</span> <?php echo $phone; ?></li>
            </ul>
        </div>
